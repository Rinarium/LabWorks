...
public class GUI {
    ...
    public GUI(final BorderPane root, final Shop shop) {
        ...
        productCombo.getItems().addAll("Хлеб", "Спички");
        ...
        HBox productQuantityBox = addStatus("Количество: ", quantityInfoLabel);
        ...
        productHandText.setFont(Font.font("Tahoma", FontWeight.SEMI_BOLD, 20));
        ...
        mainProductCombo.getItems().addAll("Хлеб", "Спички");
        ...
        gridPane.add(mainProductBox, 4, 0, 1, 1);
